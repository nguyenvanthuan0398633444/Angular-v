...
import { BinaryDataEntity } from '../entities/binary-data.entity';

@ObjectType()
export class BinaryResponse {
  @Field(() => [BinaryDataEntity], { nullable: true })
  ...
  constructor(status: number, result: BinaryDataEntity[], message: string) {
    this.status = status;
    switch (status) {
